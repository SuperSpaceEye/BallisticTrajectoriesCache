...
if __name__ == "__main__":
    # res = make_dataset_iterative(initial_speed=16, length=32, amin=-30, amax=60, gravity=0.05, drag=0.99,
    ...
    res = make_dataset_endals(
        initial_speed=16, length=32, amin=-30, amax=60, gravity=0.05, drag=0.99,
        max_height_above=1024, max_height_below=1024, num_threads=15, verbose=True,
        max_distance=7000, step=1, impossible_cutoff=700000
    )
